...
const HomeConfig = [
  {
    ...
    bgColor: "url('/assets/illustrations/BG_Body.png')",
    data: [
      {
        name: 'ANTI_AGING_CREAM',
  ...
  {
    title: 'FLOWER_COLLECTION',
    bgColor: "url('/assets/illustrations/BG_FLower.png')",
    data: [
      {
  ...
  {
    title: 'OIL_COLLECTION',
    bgColor: "url('/assets/illustrations/BG_Oil.png')",
    data: [
      {
        name: 'Hemp_oil_10',
  ...
  {
    title: 'FOOD_COLLECTION',
    bgColor: "url('/assets/illustrations/BG_Food.png')",
    data: [
      {
        name: 'Blueberry_Gummie',
      ...
      {
        name: 'Grape_blackberry_raspberry_drink',
